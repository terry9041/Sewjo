                                ...
                                <div key={index} className="mb-2">
                                    <div><strong>Length:</strong>
                                        <input
                                            ...
                                            value={fabric.length}
                                            onChange={(e) => {
                                                const updatedFabrics = formData?.readyFabrics.map((f, i) => i === index ? { ...f, length: Number(e.target.value) } : f);
                                                setFormData((prevState) => prevState && ({
                                                    ...prevState,
                                    ...
                                    <div><strong>Length in Meters:</strong>
                                        <input
                                            type="checkbox"
                                            name="lengthInMeters"
                                            checked={fabric.lengthInMeters}
                                            onChange={(e) => {
                                                const updatedFabrics = formData?.readyFabrics.map((f, i) => i === index ? { ...f, lengthInMeters: e.target.checked } : f);
                                                setFormData((prevState) => prevState && ({
                                                    ...prevState,
                                                    readyFabrics: updatedFabrics || []
                                                }));
                                    ...
                                    <div><strong>Width:</strong>
                                        <input
                                            ...
                                            value={fabric.width}
                                            onChange={(e) => {
                                                const updatedFabrics = formData?.readyFabrics.map((f, i) => i === index ? { ...f, width: Number(e.target.value) } : f);
                                                setFormData((prevState) => prevState && ({
                                                    ...prevState,
                                                    readyFabrics: updatedFabrics || []
                                                }));
                                    ...
                                    <div><strong>Width in Centimeters:</strong>
                                        <input
                                            type="checkbox"
                                            name="widthInCentimeters"
                                            checked={fabric.widthInCentimeters}
                                            onChange={(e) => {
                                                const updatedFabrics = formData?.readyFabrics.map((f, i) => i === index ? { ...f, widthInCentimeters: e.target.checked } : f);
                                                setFormData((prevState) => prevState && ({
                                                    ...prevState,
                                                    readyFabrics: updatedFabrics || []
                                                }));
                                    ...
                                    <div><strong>For Use:</strong>
                                        <input
                                            type="text"
                                            name="forUse"
                                            value={fabric.forUse}
                                            onChange={(e) => {
                                                const updatedFabrics = formData?.readyFabrics.map((f, i) => i === index ? { ...f, forUse: e.target.value } : f);
                                                setFormData((prevState) => prevState && ({
                                                    ...prevState,
                                                    readyFabrics: updatedFabrics || []
                                                }));
