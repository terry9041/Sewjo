...
const FabricDetail = ({ id, onClose }: FabricDetailProps) => {
    ...
    return (
      <div className="fixed inset-0 flex items-center justify-center z-[101]">
        ...
        ></div>
        <div
          className={`bg-white p-8 rounded shadow-lg max-w-3xl w-full h-4/5 overflow-y-auto relative ${isEditing ? "pt-12" : ""}`}
        >
          <svg
          ...
          {!isEditing ? (
              ...
              <div className="mb-4">
                ...
                <div className="flex flex-col gap-2">
                  <div>
                    ...
                    {fabric.lengthInMeters ? "meters" : "yards"}
                  </div>
                  <div>
                    <strong>Width:</strong> {fabric.width}{" "}
                    {fabric.widthInCentimeters ? "centimeters" : "inches"}
                  </div>
                  <div>
                    <strong>Remnant:</strong> {fabric.remnant ? "Yes" : "No"}
                  </div>
                  <div>
                    <strong>Composition:</strong> {fabric.composition}
                  </div>
                  <div>
                    <strong>Structure:</strong> {fabric.structure}
                  </div>
                  <div>
                    <strong>Color:</strong> {fabric.color}
                  </div>
                  <div>
                    <strong>Print:</strong> {fabric.print}
                  </div>
                  <div>
                    <strong>Brand:</strong> {fabric.brand}
                  </div>
                  <div>
                    <strong>Shrinkage:</strong> {fabric.shrinkage}%
                  </div>
                  <div>
                    <strong>Pre-washed:</strong>{" "}
                    {fabric.preWashed ? "Yes" : "No"}
                  </div>
                  <div>
                  ...
                  <div>
                    <strong>Stretch:</strong> {fabric.stretch ? "Yes" : "No"}
                  </div>
                  <div>
                    <strong>Sheerness:</strong> {fabric.sheerness}
                  </div>
                  <div>
                    <strong>Drape:</strong> {fabric.drape}
                  </div>
                  <div>
                    <strong>Weight:</strong> {fabric.weight}
                  </div>
            ...
            <>
              ...
              <textarea
                ...
                onChange={handleChange}
              ></textarea>
              <div className="mb-4b flex flex-col gap-4">
                ...
                <div>
                  ...
                  <div className="flex space-x-2 mt-2">
                    <button
                      ...
                      onClick={() =>
                        handleUnitChange("widthInCentimeters", true)
                      }
                    >
                      Centimeters
                    </button>
                    <button
                      ...
                      className={`py-2 px-4 rounded ${!formData?.widthInCentimeters ? "bg-blue-500 text-white" : "bg-gray-300 text-gray-700"}`}
                      onClick={() =>
                        handleUnitChange("widthInCentimeters", false)
                      }
                    >
                      Inches
                    </button>
